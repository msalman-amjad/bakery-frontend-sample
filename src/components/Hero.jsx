...
export default function Hero({ onExploreMenu }) {
  return (
    <section
      ...
      className="relative pt-6 pb-10 sm:pt-10 sm:pb-16 md:pt-14 md:pb-20 w-full overflow-hidden bg-transparent"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5 text-center lg:text-left">
            ...
            <ul
              role="list"
              className="pt-3 sm:pt-4 border-t border-[#2D1E18]/10 flex flex-wrap items-center justify-center lg:justify-start gap-5 text-xs text-[#2D1E18]/80 font-semibold"
            >
          ...
          {/* Right Column: Clean Simple Product Card Showcase (No Holograms, No Blue Overlays) */}
          <div className="lg:col-span-5 relative w-full max-w-sm mx-auto">
            <figure className="relative rounded-2xl sm:rounded-3xl bg-[#FFFDF9] p-3.5 sm:p-4 shadow-lg border border-[#79A03F]/25 group m-0 transition-all">
              ...
              <figcaption className="pt-3.5 pb-1 px-1 flex items-end justify-between gap-2">
                ...
                {/* Simple Solid Green Rounded Button (No Glowing Edges) */}
                <button
                  onClick={onExploreMenu}
